...
*This is a fork of [edelvarden/comfyui_image_metadata_extension](https://github.com/edelvarden/comfyui_image_metadata_extension) since it seems that edelvarden is no longer activally updating the node*
